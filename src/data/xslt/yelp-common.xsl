...
<xsl:param name="html.js.root" select="'file:///home/david/gnome/share/yelp-xsl/js/'"/>
  ...
  <xsl:if test="$node//mml:*[1]">
    <script type="text/javascript">
      <xsl:attribute name="src">
        <xsl:text>file:///home/david/gnome/share/yelp/mathjax/MathJax.js?config=yelp</xsl:text>
      </xsl:attribute>
    </script>
  </xsl:if>
</xsl:template>
